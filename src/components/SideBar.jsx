...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar - Fixed with flex column layout */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-blue-900 text-white transition-all duration-300 z-40 flex flex-col ${
      ...
      >
        ...
        <div className="flex-shrink-0 p-6 border-b border-blue-700">
          <div className="flex items-center justify-between">
            <div className={`flex items-center space-x-3 ${isCollapsed ? 'lg:justify-center' : ''}`}>
              ...
              {!isCollapsed && (
                <div>
                  <h1 className="text-xl font-bold">HealthCard</h1>
                  <p className="text-xs text-blue-300">Digital Health</p>
                </div>
              )}
            </div>
            <button
              onClick={() => setIsCollapsed(!isCollapsed)}
              className="hidden lg:block p-2 hover:bg-blue-700 rounded-lg transition"
            >
        ...
        {/* Navigation - Scrollable middle section WITHOUT visible scrollbar */}
        ...
        <div className="flex-shrink-0 p-4 border-t border-blue-700">
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg bg-red-600 hover:bg-red-700 transition text-white font-semibold shadow-lg ${
              isCollapsed ? 'lg:justify-center' : ''
            }`}
